...
function buildSummaryDataMap(wizardData, currentUser) {
  ...
  return {
    ...
    totalInterest: formatCurrency2(totalInterestCents) + ' <span class="pf-fairness-icon" title="Fairness Between Friends" style="display: inline-flex; align-items: center; vertical-align: middle;"></span>',
    totalToRepay: formatCurrency2(totalRepaymentCents) + ' <span class="pf-fairness-icon" title="Fairness Between Friends" style="display: inline-flex; align-items: center; vertical-align: middle;"></span>',
