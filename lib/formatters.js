 ...
 */
export function formatCurrency0(cents, locale = EUR_LOCALE) {
 ...
 */
export function formatCurrency2(cents, locale = EUR_LOCALE) {
 ...
 * @returns {string} Formatted currency string (e.g., "€ 3.000")
 */
export function formatEuro0(euros, locale = EUR_LOCALE) {
 ...
 * @returns {string} Formatted currency string (e.g., "€ 3.000,00")
 */
export function formatEuro2(euros, locale = EUR_LOCALE) {
